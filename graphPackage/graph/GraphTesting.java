...
public class GraphTesting {
    ...
    public void selfCeption() {
        ...
        g1.add(); g1.add(); g1.add();
        g1.add(1, 1); g1.add(1, 2);
        assertEquals(g1.edgeSize(), 2, .01);
        g1.remove(1, 1);
        assertEquals(g1.edgeSize(), 1, .01);
        g1.add(2, 2);
        g1.remove(1);
        assertEquals(g1.edgeSize(), 1, .01);
        g1.add(3, 3);
        assertEquals(g1.add(3, 3), 3, .01);
        g1.add(2, 3);
        assertEquals(g1.edgeSize(), 3, .01);
        g1.remove(3);
        assertEquals(g1.edgeSize(), 1, .01);
    }
}
