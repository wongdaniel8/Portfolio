...
class Rule {
    ...
    private boolean outOfDate() {
        //System.out.println(_target+ " does not have successor: "+(_depends.successor(_vertex, 0) == 0));
