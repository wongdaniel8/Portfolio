...
def freq_overnight_feature(text, freq):
    return float(freq['overnight'])

def freq_shipped_feature(text, freq):
    return float(freq['shipped'])

def freq_hair_feature(text, freq):
    return float(freq['hair'])
...
def freq_success_feature(text, freq):
    return float(freq['success'])

def freq_easy_feature(text, freq):
    return float(freq['easy'])

def freq_sold_feature(text, freq):
    return float(freq['sold'])

def freq_supplement_feature(text, freq):
    return float(freq['supplement'])

def freq_refund_feature(text, freq):
    return float(freq['refund'])

def freq_favorite_feature(text, freq):
    return float(freq['favorite'])
def freq_risk_feature(text, freq):
    return float(freq['risk'])
def freq_exclusive_feature(text, freq):
    return float(freq['exclusive'])
def freq_enjoy_feature(text, freq):
    return float(freq['enjoy'])
...
def freq_revolutionary_feature(text, freq):
    return float(freq['revolutionary'])
def freq_stamina_feature(text, freq):
    return float(freq['stamina'])
...
def generate_feature_vector(text, freq):
    ...
    feature.append(freq_shipped_feature(text, freq))
    feature.append(freq_hair_feature(text, freq))
    feature.append(freq_save_feature(text, freq))
    feature.append(freq_click_feature(text, freq))
    feature.append(freq_success_feature(text, freq))
    feature.append(freq_easy_feature(text, freq))
    feature.append(freq_sold_feature(text, freq))
    feature.append(freq_supplement_feature(text, freq))
    feature.append(freq_refund_feature(text, freq))

    feature.append(freq_favorite_feature(text, freq))
    feature.append(freq_risk_feature(text, freq))
    feature.append(freq_exclusive_feature(text, freq))
    feature.append(freq_enjoy_feature(text, freq))
    ...
    # feature.append(freq_revolutionary_feature(text, freq))
    # feature.append(freq_stamina_feature(text, freq))
